...
_datasets_root = "/home/evacheng/datasets"
...
register_coco_instances(name = '100DOH_hand_VAL', metadata = {}, json_file = os.path.join(_datasets_root, "annotations", mask_source, "test.json"), image_root = os.path.join(_datasets_root,image_source))
...
class CosEvaluator(COCOEvaluator):
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        f = open(os.path.join("/home/evacheng/val_results/400k_train_Ayda_val_sam_test/not_blur_on_not_blur/", "metrics.json"), 'w')
...
def main(args):
    ...
    cfg.OUTPUT_DIR = "/home/evacheng/val_results/400k_train_Ayda_val_sam_test/not_blur_on_not_blur/"
