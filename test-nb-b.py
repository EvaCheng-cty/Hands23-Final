...
class CosEvaluator(COCOEvaluator):
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        f = open(os.path.join("/home/evacheng/val_results/400k_train_Ayda_val_sam_test/not_blur_on_blur/", "metrics.json"), 'w')
...
def main(args):
    ...
    cfg.OUTPUT_DIR = "/home/evacheng/val_results/400k_train_Ayda_val_sam_test/not_blur_on_blur/"
