...
#_datasets_root = "/home/evacheng/Ayda"
...
register_coco_instances(name = '100DOH_hand_VAL', metadata = {}, json_file = os.path.join(_datasets_root, "annotations", mask_source, "val.json"), image_root = os.path.join(_datasets_root, "val"))
...
def main(args):
    ...
    cfg.OUTPUT_DIR = "/home/evacheng/val_results/400k_a_a/"
    os.makedirs( cfg.OUTPUT_DIR, exist_ok= True)

    cfg.MODEL.WEIGHTS = "/y/evacheng/final_weights/final_on_blur_model_0399999.pth"
    #cfg.MODEL.WEIGHTS = "/home/evacheng/final_on_blur/model_0354999.pth"
    cfg.freeze()
