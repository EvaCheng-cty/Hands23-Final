...
register_coco_instances(name = '100DOH_hand_VAL', metadata = {}, json_file = "/y/evacheng/val_hands/annotations/val.json", image_root = "/y/evacheng/val_hands/val/")
MetadataCatalog.get(f'100DOH_hand_VAL').set(evaluator_type= "coco").thing_class = ["hand", "firstobject", "secondobject"]

# register_coco_instances(name = '100DOH_hand_VAL', metadata = {}, json_file = "/y/evacheng/val_hands/annotations/val.json", image_root = "/y/evacheng/val_hands/val_unblurr/")
# MetadataCatalog.get(f'100DOH_hand_VAL').set(evaluator_type= "coco").thing_class = ["hand", "firstobject", "secondobject"]


# register_coco_instances(name = '100DOH_hand_VAL', metadata = {}, json_file = "/y/evacheng/val_sample/annotations/val.json", image_root = "/y/evacheng/val_sample/val/")
# MetadataCatalog.get(f'100DOH_hand_VAL').set(evaluator_type= "coco").thing_class = ["hand", "targetobject", "secondobject"]
...
# coco_api = COCO("/y/evacheng/val_hands/annotations/val.json")
# tasks = ['bbox', 'segm']
...
def main(args):
    ...
    cfg.OUTPUT_DIR = "/home/evacheng/val_results/400k/thresh-0.7-0.3-0.3/"
