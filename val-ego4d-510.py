...
_datasets_root = "/launch/evacheng/Ego4d/Ego_val/"
...
class CosEvaluator(COCOEvaluator):
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        f = open(os.path.join( "/home/evacheng/val_results/400k_sam/", "metrics.json"), 'w')
...
def main(args):
    ...
    cfg.OUTPUT_DIR = "/home/evacheng/val_results/400k_ego4d_Model1_510k/"
    os.makedirs(cfg.OUTPUT_DIR, exist_ok=True)

    cfg.MODEL.WEIGHTS = "/y/evacheng/final_weights/final_on_blur_model_0509999.pth"
    cfg.freeze()
